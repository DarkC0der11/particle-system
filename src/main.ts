...
import { initializeColor, initializeGlobalCompositeOperation, initializeLifeTime, initializeSize, initializeTexture, initializeVelocity, intitializeRotation } from './initializers'
...
import { getRandomColor, getRandomIntegerBetweenRange } from './utils'
...
async function main () {
  ...
  const particleSystem1 = createParticleSystem({
    ...
    initializers: [
      ...
      initializeLifeTime(5000, 5000),
      initializeTexture(sparkParticleImage),
      initializeSize(100, 100),
      intitializeRotation(0, 360),
      initializeVelocity(
  ...
  const particleSystem4 = createParticleSystem({
    ...
    initializers: [
      ...
      initializeGlobalCompositeOperation('lighter'),
      initializeLifeTime(1000, 2000),
      initializeTexture(glowParticleImage),
      initializeSize(20, 80),
      initializeVelocity(
        createVector2(-0.01, -0.01),
        createVector2(0.01, 0.01)
